...
public final class Utils
{
    ...
    /**
     * @return The direction you have to take to move from point "from" to point "to".
     *         This method assumes that the points have at least one common coordinate.
     */
    ...
    /**
     * @return The direction you have to take to move from point "from" to point "to".
     *         This method assumes that the cells are neighboring.
     */
    ...
    /**
     * Convert pixel coordinates to grid cell coordinates. Copied from com.jdyna.BoardInfo
     * class and adapted.
     */
    ...
    /**
     * Convert from grid coordinates to pixel data. The result is the centerpoint of the
     * grid's cell. Copied from com.jdyna.BoardInfo class and adapted.
     */
    ...
    /**
     * @return <code>True</code> if the cells are neighboring and <code>false</code>
     *         otherwise.
     */
    ...
    /**
     * @return <code>True</code> if the given player has won the game and
