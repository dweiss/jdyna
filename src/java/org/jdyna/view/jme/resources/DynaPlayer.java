...
public class DynaPlayer extends DynaObject
{
    ...
    private class ImmortalityController extends Controller {
    	...
    	private BlendState state = DisplaySystem.getDisplaySystem().getRenderer().createBlendState();
		private float phase;
        {
		...
		public void setActive(boolean active) {
			...
			setRenderQueueMode(active ? Renderer.QUEUE_TRANSPARENT : Renderer.QUEUE_INHERIT);
