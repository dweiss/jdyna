...
public class JMEPlayerController implements IPlayerController
{
    ...
    {
        new JMEPlayerController(1), new JMEPlayerController(2)
    };
    ...
    static
    {
        ...
        km.set("bomb_1", KeyInput.KEY_RSHIFT);
    ...
    public Direction getCurrent()
    {
        ...
        if (km.isValidCommand("up_" + playerNumber)) dir = Direction.UP;
        else if (km.isValidCommand("down_" + playerNumber)) dir = Direction.DOWN;
        else if (km.isValidCommand("left_" + playerNumber)) dir = Direction.LEFT;
        else if (km.isValidCommand("right_" + playerNumber)) dir = Direction.RIGHT;
