...
public class Space {
    ...
    /**
     * List of timers representing time left until the explosions that will
     * affect this space.
     */
    ...
    /**
     * Checks if there are any ongoing or expected explosions affecting this
     * space.
     */
    ...
    /**
     * Checks if there will be no explosions affecting this space in the given
     * time window.
     * 
     * @param from
     *            number of frames until the start of the window
     * @param to
     *            number of frames until the end of the window
     */
    ...
    /**
     * Checks how much time is left until the beginning of the next expected
     * explosion affecting this space.
     * <p>
     * Any ongoing explosions affecting this space are ignored.
     * 
     * @return the number of frames left until the explosion, or
     *         <code>null</code> if no explosions are expected on this space
     */
