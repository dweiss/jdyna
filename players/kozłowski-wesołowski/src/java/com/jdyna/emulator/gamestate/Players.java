...
final class Players {
	...
	private final List<IPlayersInformationListener> playersPositionsListeners = Lists.newArrayList();
	private final List<IPlayersInformationListener> rangesListeners = Lists.newArrayList();
	 ...
	 */
	public Players(final List<? extends IPlayerSprite> playersSrc, final String currentPlayer) {
